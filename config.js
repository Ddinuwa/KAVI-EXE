...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KAVI-EXE=R1Zwjb4Y#zdxrHbvjj3Tb_P0yFrJvfSNP4ctjLuweQSBWfNWN5BY",
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "*SEEN YOUR STATUS BY HESHAN 🤍*",
